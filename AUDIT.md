...
- Документировать процесс актуализации `JSONS/referenceSourcesMVP.json`, чтобы сборка могла работать автономно.
